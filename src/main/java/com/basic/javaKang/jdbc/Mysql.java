...
public class Mysql extends JDBC {
    public  String url="jdbc:mysql://localhost:3306/atguigu";
    @Override
    public void connect() throws Exception {
        ...
        String user = properties.getProperty("userM");
        String password = properties.getProperty("passwordM");
        String url = properties.getProperty("urlM");
        String driverClass = properties.getProperty("driverClassM");
